...
class TestMessages:
    ...
    def test_raw_response_retrieve(self, client: Twopir) -> None:
        response = client.tune.prompt.messages.with_raw_response.retrieve(
            "job_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Twopir) -> None:
        with client.tune.prompt.messages.with_streaming_response.retrieve(
            "job_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Twopir) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.tune.prompt.messages.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncMessages:
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTwopir) -> None:
        response = await async_client.tune.prompt.messages.with_raw_response.retrieve(
            "job_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTwopir) -> None:
        async with async_client.tune.prompt.messages.with_streaming_response.retrieve(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTwopir) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.tune.prompt.messages.with_raw_response.retrieve(
                "",
            )
