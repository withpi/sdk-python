...
class TestChatCompletions:
    ...
    def test_method_list(self, client: PiClient) -> None:
        chat_completion = client.model.sft.chat_completions.list(
            "job_id",
        )
    ...
    def test_raw_response_list(self, client: PiClient) -> None:
        response = client.model.sft.chat_completions.with_raw_response.list(
            "job_id",
        )
    ...
    def test_streaming_response_list(self, client: PiClient) -> None:
        with client.model.sft.chat_completions.with_streaming_response.list(
            "job_id",
        ) as response:
    ...
    def test_path_params_list(self, client: PiClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.model.sft.chat_completions.with_raw_response.list(
                "",
            )
...
class TestAsyncChatCompletions:
    ...
    async def test_method_list(self, async_client: AsyncPiClient) -> None:
        chat_completion = await async_client.model.sft.chat_completions.list(
            "job_id",
        )
        assert_matches_type(object, chat_completion, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncPiClient) -> None:
        response = await async_client.model.sft.chat_completions.with_raw_response.list(
            "job_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncPiClient) -> None:
        async with async_client.model.sft.chat_completions.with_streaming_response.list(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncPiClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.model.sft.chat_completions.with_raw_response.list(
                "",
            )
