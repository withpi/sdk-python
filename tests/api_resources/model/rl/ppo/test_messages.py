...
class TestMessages:
    ...
    def test_method_stream(self, client: PiClient) -> None:
        message = client.model.rl.ppo.messages.stream(
            "job_id",
        )
    ...
    def test_raw_response_stream(self, client: PiClient) -> None:
        response = client.model.rl.ppo.messages.with_raw_response.stream(
            "job_id",
        )
    ...
    def test_streaming_response_stream(self, client: PiClient) -> None:
        with client.model.rl.ppo.messages.with_streaming_response.stream(
            "job_id",
        ) as response:
    ...
    def test_path_params_stream(self, client: PiClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.model.rl.ppo.messages.with_raw_response.stream(
                "",
            )
...
class TestAsyncMessages:
    ...
    async def test_method_stream(self, async_client: AsyncPiClient) -> None:
        message = await async_client.model.rl.ppo.messages.stream(
            "job_id",
        )
        assert_matches_type(str, message, path=["response"])
    ...
    async def test_raw_response_stream(self, async_client: AsyncPiClient) -> None:
        response = await async_client.model.rl.ppo.messages.with_raw_response.stream(
            "job_id",
        )
    ...
    async def test_streaming_response_stream(self, async_client: AsyncPiClient) -> None:
        async with async_client.model.rl.ppo.messages.with_streaming_response.stream(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_stream(self, async_client: AsyncPiClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.model.rl.ppo.messages.with_raw_response.stream(
                "",
            )
