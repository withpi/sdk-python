...
class TestGenerateInputResponsePairs:
    ...
    def test_method_create(self, client: PiClient) -> None:
        generate_input_response_pair = client.data.generate_input_response_pairs.create(
    ...
    def test_raw_response_create(self, client: PiClient) -> None:
        response = client.data.generate_input_response_pairs.with_raw_response.create(
            num_examples_to_generate=50,
            seeds=[
                {
                    "llm_input": "Tell me something different",
    ...
    def test_streaming_response_create(self, client: PiClient) -> None:
        with client.data.generate_input_response_pairs.with_streaming_response.create(
            num_examples_to_generate=50,
            seeds=[
                {
                    "llm_input": "Tell me something different",
...
class TestAsyncGenerateInputResponsePairs:
    ...
    async def test_method_create(self, async_client: AsyncPiClient) -> None:
        generate_input_response_pair = await async_client.data.generate_input_response_pairs.create(
            num_examples_to_generate=50,
            seeds=[
                {
                    "llm_input": "Tell me something different",
    ...
    async def test_raw_response_create(self, async_client: AsyncPiClient) -> None:
        response = await async_client.data.generate_input_response_pairs.with_raw_response.create(
            num_examples_to_generate=50,
            seeds=[
                {
                    "llm_input": "Tell me something different",
    ...
    async def test_streaming_response_create(self, async_client: AsyncPiClient) -> None:
        async with async_client.data.generate_input_response_pairs.with_streaming_response.create(
            num_examples_to_generate=50,
            seeds=[
                {
                    "llm_input": "Tell me something different",
