...
class TestGenerateFromSeeds:
    ...
    def test_method_cancel(self, client: PiClient) -> None:
        ...
        assert_matches_type(object, generate_from_seed, path=["response"])
    ...
    def test_method_list_jobs(self, client: PiClient) -> None:
        generate_from_seed = client.data.inputs.generate_from_seeds.list_jobs()
        assert_matches_type(GenerateFromSeedListJobsResponse, generate_from_seed, path=["response"])
    ...
    def test_raw_response_list_jobs(self, client: PiClient) -> None:
        response = client.data.inputs.generate_from_seeds.with_raw_response.list_jobs()
    ...
    def test_streaming_response_list_jobs(self, client: PiClient) -> None:
        with client.data.inputs.generate_from_seeds.with_streaming_response.list_jobs() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncGenerateFromSeeds:
    ...
    async def test_method_list_jobs(self, async_client: AsyncPiClient) -> None:
        generate_from_seed = await async_client.data.inputs.generate_from_seeds.list_jobs()
        assert_matches_type(GenerateFromSeedListJobsResponse, generate_from_seed, path=["response"])
    ...
    async def test_raw_response_list_jobs(self, async_client: AsyncPiClient) -> None:
        response = await async_client.data.inputs.generate_from_seeds.with_raw_response.list_jobs()
    ...
    async def test_streaming_response_list_jobs(self, async_client: AsyncPiClient) -> None:
        async with async_client.data.inputs.generate_from_seeds.with_streaming_response.list_jobs() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
