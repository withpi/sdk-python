...
```python
from withpi.types import ScoringSystemGenerateV2Response, ScoringSystemScoreV2Response
```
...
- <code title="post /scoring_system/generate_v2">client.scoring_system.<a href="./src/withpi/resources/scoring_system/scoring_system.py">generate_v2</a>(\*\*<a href="src/withpi/types/scoring_system_generate_v2_params.py">params</a>) -> <a href="./src/withpi/types/scoring_system_generate_v2_response.py">ScoringSystemGenerateV2Response</a></code>
...
- <code title="post /scoring_system/score_v2">client.scoring_system.<a href="./src/withpi/resources/scoring_system/scoring_system.py">score_v2</a>(\*\*<a href="src/withpi/types/scoring_system_score_v2_params.py">params</a>) -> <a href="./src/withpi/types/scoring_system_score_v2_response.py">ScoringSystemScoreV2Response</a></code>
