...
from ...types.data import generate_input_list_params, generate_input_start_job_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                generate_input_start_job_params.GenerateInputStartJobParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
