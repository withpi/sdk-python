...
from ...types.data import generate_input_response_pair_list_params, generate_input_response_pair_create_params
...
class GenerateInputResponsePairsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        seeds: Iterable[generate_input_response_pair_create_params.Seed],
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                generate_input_response_pair_create_params.GenerateInputResponsePairCreateParams,
            ),
...
class GenerateInputResponsePairsResourceWithRawResponse:
    def __init__(self, generate_input_response_pairs: GenerateInputResponsePairsResource) -> None:
        ...
        self.create = to_raw_response_wrapper(
            generate_input_response_pairs.create,
        )
